...
export default async function handler(req, res) {
    ...
    const selectProduct = async () => {
        ...
        var likeData = await executeQuery("SELECT * FROM product WHERE product_no IN (SELECT product_no FROM product_like WHERE member_id = 'hoon') ORDER BY product_no DESC", [])
        // 좋아요 랭크순 상품 불러오기
